...
import { BsRssFill, BsTwitch, BsYoutube, BsSteam } from "react-icons/bs";
...
import {
  ...
  setSidebarOff,
  setSidebarOn,
} from "../../redux/store/sidebarSlice.js";
    ...
    <NavbarWrapper className="d-flex align-items-center">
      <div className="container w-100">
        <div className="navbar-content">
          <div className="navbar-and-toggler d-flex align-items-center justify-content-between">
            <Link
              to="/"
